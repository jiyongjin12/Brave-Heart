...
namespace Map
{
    public class MapView : MonoBehaviour
    {
        ...
        protected virtual void CreateMapParent()
        {
            ...
            scrollNonUi.freezeX = orientation == MapOrientation.Bottom || orientation == MapOrientation.Top;
